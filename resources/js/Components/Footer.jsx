            ...
            <div className="relative max-w-6xl mx-auto px-6">
                <div className="grid md:grid-cols-5 gap-x-8 gap-y-12">
                    ...
                    <div className="flex flex-col items-start space-y-4">
                        ...
                        <div className="footer-glass-card w-full">
                            <a href="https://wa.me/34977665544" target="_blank" rel="noopener noreferrer"
                               className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''} group`}>
                                <svg className="w-5 h-5 text-[#C9A646] shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <span className="text-sm text-white/60 group-hover:text-[#C9A646] transition">+34 977 66 55 44</span>
                            </a>
                        </div>
                    </div>
