            ...
            <section ref={sectionRef} className="reveal relative py-16 sm:py-20 lg:py-24 overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-5 sm:px-8">
                    <div className={`grid lg:grid-cols-5 gap-6 lg:gap-8 ${isRTL ? 'lg:direction-rtl' : ''}`}>
                        {/* Map */}
                        <div className="lg:col-span-3 home-glass-card p-2 sm:p-3 overflow-hidden">
                        ...
                        <div className="lg:col-span-2 space-y-4 sm:space-y-5">
                            <div className="home-glass-card p-5 sm:p-6">
                                <div className={`flex items-start gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                                    <div className="w-10 h-10 rounded-full bg-[#C9A646]/10 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className={isRTL ? 'text-right' : ''}>
                                        ...
                                        <p className="text-[#0F3B2E] font-semibold mt-1">{address}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="home-glass-card p-5 sm:p-6">
                                    <div className={`flex items-start gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                                        ...
                                        <div className={isRTL ? 'text-right' : ''}>
                                            ...
                                            <p className="text-[#0F3B2E] font-semibold mt-1">{ubicacion.telefono}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="home-glass-card p-5 sm:p-6">
                                    <div className={`flex items-start gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                                        ...
                                        <div className={isRTL ? 'text-right' : ''}>
                                            ...
                                            <p className="text-[#0F3B2E] font-semibold mt-1">{ubicacion.email}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
