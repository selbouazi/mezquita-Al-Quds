            ...
            <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
                <div className="absolute inset-0 pointer-events-none">
                    <svg className="w-full h-full opacity-[0.04]" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid slice">
                        <defs>
                            <pattern id="g404bg" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                                <polygon points="40,4 76,40 40,76 4,40" fill="none" stroke="#0F3B2E" strokeWidth="0.8" />
                        ...
                        <rect width="100%" height="100%" fill="url(#g404bg)" />
                    </svg>
                    <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full border-[40px] border-[#0F3B2E]/5" />
                ...
                <div className="relative bg-white/75 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/40 p-10 sm:p-14 w-full max-w-lg text-center"
                    ...
                    <div className="relative mx-auto mb-8 w-28 h-28 flex items-center justify-center">
                        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 112 112" fill="none">
                            <polygon points="56,2 110,56 56,110 2,56" stroke="#0F3B2E" strokeWidth="1.5" opacity="0.15" />
                            <polygon points="56,10 102,56 56,102 10,56" stroke="#C9A646" strokeWidth="0.8" opacity="0.2" />
                            <polygon points="56,18 94,56 56,94 18,56" stroke="#0F3B2E" strokeWidth="0.6" opacity="0.1" />
                        </svg>
                        <span className="relative text-5xl sm:text-6xl font-bold bg-gradient-to-br from-[#0F3B2E] to-[#1a6b50] bg-clip-text text-transparent">404</span>
                    </div>

                    <svg className="mx-auto mb-6 w-12 h-12 text-[#C9A646]/40" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1">
                        <circle cx="24" cy="24" r="20" />
                        <circle cx="24" cy="24" r="10" />
                        <path d="M24 4v8M24 36v8M4 24h8M36 24h8" strokeWidth="0.8" />
                        <path d="M9.86 9.86l5.66 5.66M32.48 32.48l5.66 5.66M9.86 38.14l5.66-5.66M32.48 15.52l5.66-5.66" strokeWidth="0.6" opacity="0.6" />
                    </svg>
