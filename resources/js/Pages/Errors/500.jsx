            ...
            <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
                <div className="absolute inset-0 pointer-events-none">
                    <svg className="w-full h-full opacity-[0.04]" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid slice">
                        <defs>
                            <pattern id="g500bg" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                        ...
                        <rect width="100%" height="100%" fill="url(#g500bg)" />
                    </svg>
                ...
                <div className="relative bg-white/75 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/40 p-10 sm:p-14 w-full max-w-lg text-center"
                    ...
                    <div className="relative mx-auto mb-8 w-28 h-28 flex items-center justify-center">
                        ...
                        <span className="relative text-5xl sm:text-6xl font-bold bg-gradient-to-br from-[#DC2626] to-[#991b1b] bg-clip-text text-transparent">500</span>
                    </div>

                    <svg className="mx-auto mb-6 w-12 h-12 text-red-400/50" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1">
                        <rect x="8" y="14" width="32" height="28" rx="3" />
                        <path d="M16 14V10a8 8 0 0116 0v4" strokeWidth="1.2" />
                        <circle cx="24" cy="28" r="3" fill="currentColor" opacity="0.3" />
                        <line x1="24" y1="31" x2="24" y2="36" strokeWidth="1.5" />
                    </svg>
