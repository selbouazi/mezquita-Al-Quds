    ...
    return (
        <MainLayout title={t('navbar', 'contact')}
            ...
            <section className="relative pt-28 pb-16 sm:pb-20 lg:pb-24 overflow-hidden">
                <div className="absolute inset-0 bg-[url('/img/contacto.png')] bg-cover bg-center bg-no-repeat" />
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
                    ...
                    <svg className="absolute top-[12%] left-[8%] w-10 h-10 text-[#C9A646]/10 animate-glow-spin" viewBox="0 0 48 48" fill="none">
                        <path d="M24 2L30 18L46 24L30 30L24 46L18 30L2 24L18 18Z" stroke="currentColor" strokeWidth="0.6" />
                    </svg>
                    <svg className="absolute bottom-[15%] right-[10%] w-8 h-8 text-white/[0.06] animate-float-drift" style={{ animationDuration: '14s' }} viewBox="0 0 48 48" fill="none">
            ...
            <section ref={sectionRef} className="reveal relative py-16 sm:py-20 lg:py-24 overflow-hidden">
                ...
                <div className="relative max-w-3xl mx-auto px-5 sm:px-8">
                    ...
                    {contactType === 'phone' ? (
                        <div className="home-glass-card p-8 sm:p-10 text-center relative overflow-hidden">
                                ...
                                <svg className="w-full h-full" viewBox="0 0 200 200" preserveAspectRatio="xMidYMid slice">
                                    <defs>
                                        <pattern id="whatsapp-pattern" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
                                            <polygon points="25,3 47,25 25,47 3,25" fill="none" stroke="#C9A646" strokeWidth="0.4" opacity="0.2" />
                                            <circle cx="25" cy="25" r="6" fill="none" stroke="#C9A646" strokeWidth="0.3" opacity="0.15" />
                                        </pattern>
                                    </defs>
                            ...
                            <div className="relative">
                                <div className="w-16 h-16 mx-auto mb-5 rounded-full bg-gradient-to-br from-[#C9A646]/20 to-[#C9A646]/5 flex items-center justify-center ring-2 ring-[#C9A646]/20 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <a href="https://wa.me/34644428283" target="_blank" rel="noopener noreferrer"
                                   className="group/whatsapp inline-flex items-center gap-3 text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0F3B2E] hover:text-[#C9A646] transition-all duration-300 hover:-translate-y-0.5">
                                    <svg className="w-8 h-8 transition-transform duration-200 group-hover/whatsapp:scale-110" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <form ref={formRef} onSubmit={handleSubmit}
                              className="home-glass-card p-6 sm:p-8 lg:p-10 relative overflow-hidden">
                            {/* Decorative corner SVGs */}
                            <svg className="absolute -top-6 -right-6 w-20 h-20 text-[#C9A646]/5 pointer-events-none rotate-45" viewBox="0 0 48 48" fill="none">
                                <path d="M24 2L30 18L46 24L30 30L24 46L18 30L2 24L18 18Z" stroke="currentColor" strokeWidth="0.5" />
                                <circle cx="24" cy="24" r="10" stroke="currentColor" strokeWidth="0.3" opacity="0.5" />
                            </svg>
                            <svg className="absolute -bottom-6 -left-6 w-20 h-20 text-[#C9A646]/5 pointer-events-none" viewBox="0 0 48 48" fill="none">
                                <path d="M24 2L30 18L46 24L30 30L24 46L18 30L2 24L18 18Z" stroke="currentColor" strokeWidth="0.5" />
                                <circle cx="24" cy="24" r="10" stroke="currentColor" strokeWidth="0.3" opacity="0.5" />
                            </svg>
                            <div className="space-y-5">
                                <div className={`grid sm:grid-cols-2 gap-5 ${isRTL ? 'sm:direction-rtl' : ''}`}>
                                    <div>
                                        ...
                                        <input id="contact-name" type="text" name="name" required
                                            ...
                                            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#C9A646]/40 focus:border-[#C9A646]/60 transition-all bg-white/80 hover:border-[#C9A646]/30" />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea id="contact-message" name="message" required
                                        ...
                                        className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm h-36 focus:outline-none focus:ring-2 focus:ring-[#C9A646]/40 focus:border-[#C9A646]/60 transition-all bg-white/80 resize-none hover:border-[#C9A646]/30" />
                                </div>
                                <div className={`flex ${isRTL ? 'justify-start' : 'justify-end'}`}>
                                    <button
                                        type="submit"
                                        disabled={sending}
                                        className="group/btn inline-flex items-center gap-2 bg-gradient-to-r from-[#0F3B2E] to-[#09291e] text-white px-8 py-3.5 rounded-xl font-bold text-sm sm:text-base shadow-lg hover:shadow-[#0F3B2E]/30 hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 active:scale-[0.97]"
                                    >
                                        {sending ? (
                                            <>
                                            ...
                                            <>
                                                {t('contacto', 'send')}
                                                <svg className={`w-5 h-5 transform group-hover/btn:translate-x-0.5 transition-transform duration-200 ${isRTL ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            {/* MODAL — glass-morphism premium */}
            {modal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4"
                     onClick={() => { if (modal !== 'sending') setModal(null); }}>
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" />
                    <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl max-w-md w-full p-8 sm:p-10 text-center overflow-hidden"
                            ...
                            <svg className="w-full h-full" viewBox="0 0 200 200" preserveAspectRatio="xMidYMid slice">
                                <defs>
                                    <pattern id="modal-pattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                                        ...
                                        <circle cx="20" cy="20" r="3" fill="none" stroke="#C9A646" strokeWidth="0.3" />
                                    </pattern>
                                </defs>
                        ...
                        {/* Corner stars */}
                        <svg className="absolute -top-4 -right-4 w-16 h-16 text-[#C9A646]/10 pointer-events-none rotate-45" viewBox="0 0 48 48" fill="none">
                            <path d="M24 2L30 18L46 24L30 30L24 46L18 30L2 24L18 18Z" stroke="currentColor" strokeWidth="0.4" />
                        </svg>
                        <svg className="absolute -bottom-4 -left-4 w-16 h-16 text-[#C9A646]/10 pointer-events-none" viewBox="0 0 48 48" fill="none">
                            <path d="M24 2L30 18L46 24L30 30L24 46L18 30L2 24L18 18Z" stroke="currentColor" strokeWidth="0.4" />
                        </svg>
                        <div className="relative">
                            {modal === 'sending' ? (
                                ...
                                <>
                                    <div className="w-16 h-16 mx-auto mb-5 rounded-full bg-gradient-to-br from-green-100 to-green-50 flex items-center justify-center ring-2 ring-green-200/50">
                                    ...
                                    <button onClick={() => setModal(null)}
                                            className="px-6 py-2.5 bg-gradient-to-r from-[#0F3B2E] to-[#09291e] text-white rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-[#0F3B2E]/20 transition-all hover:-translate-y-0.5 active:scale-[0.97]">
                                        Cerrar
                                    </button>
                                </>
                            ) : (
                                <>
                                    <div className="w-16 h-16 mx-auto mb-5 rounded-full bg-gradient-to-br from-red-100 to-red-50 flex items-center justify-center ring-2 ring-red-200/50">
